    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          ...
          <li>
              <a
                href="mailto:varshavulli@gmail.com"
              ...
              >
                ...
                >
                  <path
                    d="M30.832 4.16682C30.832 3.9792 30.7392 3.88641 30.5516 3.88641H1.44804C1.26042 3.88641 1.16763 3.9792 1.16763 4.16682C1.16763 4.35444 1.26042 4.44723 1.44804 4.44723H30.5516C30.7392 4.44723 30.832 4.35444 30.832 4.16682ZM16 15.7195L2.43067 6.40576C2.14688 6.23228 1.7678 6.32748 1.59432 6.61127C1.42084 6.89506 1.51603 7.27414 1.79982 7.44762L15.3667 16.7614C15.4515 16.8181 15.5485 16.8181 15.6333 16.7614L29.2002 7.44762C29.484 7.27414 29.5792 6.89506 29.4058 6.61127C29.2323 6.32748 28.8532 6.23228 28.5694 6.40576L15 15.7195V15.7195ZM1.44804 27.5528C1.26042 27.5528 1.16763 27.6456 1.16763 27.8332C1.16763 28.0208 1.26042 28.1136 1.44804 28.1136H30.5516C30.7392 28.1136 30.832 28.0208 30.832 27.8332C30.832 27.6456 30.7392 27.5528 30.5516 27.5528H1.44804Z"
                    fill="black"
                    stroke="black"
                    strokeWidth="2"
                    strokeLinecap="round"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/varsha-vulli"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
